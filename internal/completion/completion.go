...
var command = &complete.Command{
	Sub: map[string]*complete.Command{
		...
		"stop":           {},
		"status":         {Flags: map[string]complete.Predictor{"json": predict.Nothing, "live": predict.Nothing}},
		...
		"list-rules":     {Flags: map[string]complete.Predictor{"json": predict.Nothing}},
		"reload-rules":   {},
		"lint-rules":     {Flags: map[string]complete.Predictor{"info": predict.Nothing}, Args: predict.Files("*.yaml")},
		"wrap":           {Flags: map[string]complete.Predictor{"dry-run": predict.Nothing}, Args: predict.Something},
		"check-sandbox":  {},
		"repair-sandbox": {},
		"uninstall":      {},
		"help":           {},
